...
output = 'output.csv'; % AP EDIT
% AP EDIT - MODIFY -- name of output file to reflect participant ID
textfile = 'text.txt'; % AP EDIT
% AP EDIT - MODIFY -- name of text file to reflect participant ID
diary(output); % AP EDIT
diary(textfile); % AP EDIT
